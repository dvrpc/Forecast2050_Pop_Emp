...
<div id="legend-box-Item" class="circle popPER-4"><span>Exceptional Growth (Above 50%)</span></div>
</div>
</div>
`;
}
...
<div id="legend-box-Item" class="circle pop-1"><span>Less Than 1,000</span></div>
  <div id="legend-box-Item" class="circle pop-2"><span>1,000 to 2,499</span></div>
  <div id="legend-box-Item" class="circle pop-3"><span>2,500 to 4,999</span></div>
  <div id="legend-box-Item" class="circle pop-4"><span>5,000 to 7,499</span></div>
  <div id="legend-box-Item" class="circle pop-5"><span>7,500 or More</span></div>
</div>
</div>
`;
}
...
`;
  ...
  <div id="legend-box-Item" class="circle empABS-1"><span>Less Than 0</span></div>
  <div id="legend-box-Item" class="circle emp-1"><span>1 to 999</span></div>
  <div id="legend-box-Item" class="circle emp-2"><span>1,000 to 1,999</span></div>
  <div id="legend-box-Item" class="circle emp-3"><span>2,000 to 2,999</span></div>
  <div id="legend-box-Item" class="circle emp-4"><span>3,000 or More</span></div>
  </div>
  </div>
  `;
    }
    ...
    <div id="legend-box-Item" class="circle emp-1"><span>Stable (-5% to 5%)</span></div>
    <div id="legend-box-Item" class="circle emp-2"><span>Moderate Growth (+6% to 25%)</span></div>
    <div id="legend-box-Item" class="circle emp-3"><span>Significant Growth (+26% to +50%)</span></div>
    <div id="legend-box-Item" class="circle emp-4"><span>Exceptional Growth (Above 50%)</span></div>
    </div>
    </div>
    `;
      }
      ...
      <div id="legend-box-Item" class="circle emp-1"><span>Less Than 500</span></div>
      <div id="legend-box-Item" class="circle emp-2"><span>500 to 1,499</span></div>
      <div id="legend-box-Item" class="circle emp-3"><span>1,500 to 2,999</span></div>
      <div id="legend-box-Item" class="circle emp-4"><span>3,000 to 5,999</span></div>
      <div id="legend-box-Item" class="circle emp-5"><span>6,000 or More</span></div>
      </div>
      </div>
      `;
        }
