...
var empPER50 = empABS50 / props.emp45 ;
    ...
    var info = '<table id="crashtable">'+
      ...
      '<tr class="odd">'+
      '<th>2020</th><td>' + numeral(props.pop20).format('0,0')+ '</td><td>' + numeral(popABS20).format('0,0') +' ('+numeral(popPER20).format('0.0%')+')</td><td>' + numeral(props.emp20).format('0,0') + '</td><td>' + numeral(empABS20).format('0,0') +' ('+numeral(empPER20).format('0.0%')+')</td>' +  
      '<tr class="even">'+
      '<th>2025</th><td>' + numeral(props.pop25).format('0,0')+ '</td><td>' + numeral(popABS25).format('0,0') +' ('+numeral(popPER25).format('0.0%')+')</td><td>' + numeral(props.emp25).format('0,0') + '</td><td>' + numeral(empABS25).format('0,0') +' ('+numeral(empPER25).format('0.0%')+')</td>' +  
      '<tr class="odd">'+
      '<th>2030</th><td>' + numeral(props.pop30).format('0,0')+ '</td><td>' + numeral(popABS30).format('0,0') +' ('+numeral(popPER30).format('0.0%')+')</td><td>' + numeral(props.emp30).format('0,0') + '</td><td>' + numeral(empABS30).format('0,0') +' ('+numeral(empPER30).format('0.0%')+')</td>' +  
      '<tr class="even">'+
      '<th>2035</th><td>' + numeral(props.pop35).format('0,0')+ '</td><td>' + numeral(popABS35).format('0,0') +' ('+numeral(popPER35).format('0.0%')+')</td><td>' + numeral(props.emp35).format('0,0') + '</td><td>' + numeral(empABS35).format('0,0') +' ('+numeral(empPER35).format('0.0%')+')</td>' +  
      '<tr class="odd">'+
      '<th>2040</th><td>' + numeral(props.pop40).format('0,0')+ '</td><td>' + numeral(popABS40).format('0,0') +' ('+numeral(popPER40).format('0.0%')+')</td><td>' + numeral(props.emp40).format('0,0') + '</td><td>' + numeral(empABS40).format('0,0') +' ('+numeral(empPER40).format('0.0%')+')</td>' +  
      '<tr class="even">'+
      '<th>2045</th><td>' + numeral(props.pop45).format('0,0')+ '</td><td>' + numeral(popABS45).format('0,0') +' ('+numeral(popPER45).format('0.0%')+')</td><td>' + numeral(props.emp45).format('0,0') + '</td><td>' + numeral(empABS45).format('0,0') +' ('+numeral(empPER45).format('0.0%')+')</td>' +  
      '<tr class="odd">'+
      '<th>2050</th><td>' + numeral(props.pop50).format('0,0')+ '</td><td>' + numeral(popABS50).format('0,0') +' ('+numeral(popPER50).format('0.0%')+')</td><td>' + numeral(props.emp50).format('0,0') + '</td><td>' + numeral(empABS50).format('0,0') +' ('+numeral(empPER50).format('0.0%')+')</td>' +  
      '</tbody>'+						
        '<table>'; 
